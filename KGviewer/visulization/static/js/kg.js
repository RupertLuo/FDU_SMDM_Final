initKG = function (data, config, container) {
    ...
    if (!config.nodeColor || config.nodeColor === "")
        var defaultNodeColor = [
            //粉红
            { fill: "#57C7E3", stroke: "#23b3d7", text: "rgb(60, 60, 60)" },
            //灰色
            { fill: "#FFC454", stroke: "#d7a013", text: "rgb(60, 60, 60)" },
            { fill: "#4C8EDA", stroke: "#2870c2", text: "rgb(60, 60, 60)" },
    ...
    var width = config.width? config.width:1200,
        height = config.height? config.height:750;
